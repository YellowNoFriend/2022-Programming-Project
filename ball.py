...
class Ball(object):
    ...
    '''
    # We assume that every ball have the same size.
    size = 100
    def __init__(self, x, y, x_step, y_step):
        '''
...
def bouncing_ball_ext(ball, speed_factor=5,gravity=9.81):
    ...
    print("The forward horizontal step size is  x_step = {}".format(ball.x_step))
    print("The forward vertical step size is    y_step = {}".format(ball.y_step))
